  ...
  return (
    <div>
      ...
      {isLoading ? (
        ...
        <PanelStack storageKey="revenue" panels={[
          {
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        ...
                        <tr className="border-t-2 border-border font-bold">
                          ...
                          <td className="py-3 px-2" /><td className="py-3 px-2 text-right text-primary">${totalHouse.toLocaleString()}</td>
                          <td className="py-3 px-2" /><td className="py-3 px-2 text-right">${totalDancer.toLocaleString()}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
          ...
          {
            id: "bar", label: "Revenue by Period",
            node: (
              <div className="glass-card p-6">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={chartData}>
                    ...
                    <Tooltip contentStyle={chartTooltipStyle} formatter={(value: number, name: string) => [`$${value.toLocaleString()}`, { door: "Door", room: "Room" }[name] || name]} />
          ...
          {
            id: "split", label: "Revenue Split & Comparison",
            node: (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="glass-card p-6">
                  ...
                  <p className="text-center text-primary font-heading text-2xl mt-2">${(stats.doorRevenue + stats.roomRevenue).toLocaleString()} Total</p>
                </div>
                <div className="glass-card p-6">
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <LineChart data={prevWeekData}>
                      ...
                      <YAxis stroke="hsl(240 8% 45%)" tick={{ fontSize: 12 }} />
                      <Tooltip contentStyle={chartTooltipStyle} formatter={(value: number, name: string) => [`$${value.toLocaleString()}`, name === "thisWeek" ? "This Period" : "Prior Period"]} />
